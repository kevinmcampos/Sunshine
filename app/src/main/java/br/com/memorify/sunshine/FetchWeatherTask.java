...
public class FetchWeatherTask extends AsyncTask<Void, Void, String[]> {
    ...
    protected String[] doInBackground(Void... params) {
        ...
        try {
            ...
            final String OPEN_WEATHER_MAP_BASE_URL = "http://api.openweathermap.org/data/2.5/forecast/daily";
            ...
            Uri uri = Uri.parse(OPEN_WEATHER_MAP_BASE_URL).buildUpon()
                    .appendQueryParameter(QUERY_PARAM, QUERY)
                    .appendQueryParameter(FORMAT_PARAM, FORMAT)
                    .appendQueryParameter(UNITS_PARAM, UNITS)
                    .appendQueryParameter(NUM_DAYS_PARAM, String.valueOf(NUM_OF_DAYS))
    ...
    protected void onPostExecute(String[] weatherForecasts) {
        if (weatherForecasts == null) {
            ...
            callbacks.onSuccess(weatherForecasts);
        }
    }
}
